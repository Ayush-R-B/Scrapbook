      ...
      <div className="hidden lg:flex lg:col-span-6 relative bg-cream-dark/20 border-r border-beige/45 flex-col justify-between p-12 overflow-hidden select-none">
        ...
        <div className="relative w-full max-w-sm mx-auto h-[380px] flex items-center justify-center">
          <motion.div
            ...
            className="absolute top-8 right-4 w-48 p-3 pb-8 polaroid-frame"
          >
            ...
            <p className="font-handwritten text-lg font-bold text-center mt-3 text-ink-muted">College Days 🎓</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute bottom-6 left-4 w-48 p-3 pb-8 polaroid-frame"
          >
            <div className="aspect-square overflow-hidden rounded-xs border border-beige/20">
            ...
            <p className="font-handwritten text-lg font-bold text-center mt-3 text-ink-muted">Family 👨‍👩‍👧</p>
          </motion.div>
        </div>
        ...
        <div className="z-10 max-w-sm self-center text-center">
          <h2 className="font-display text-3xl font-bold text-ink italic leading-[1.2] mb-3">
            "Design a digital canvas for the moments you'll cherish forever."
          </h2>
          <p className="text-[9px] uppercase tracking-widest font-bold font-sans text-brown-light">— ScrapBook Team</p>
        </div>
      ...
      <div className="col-span-12 lg:col-span-6 flex items-center justify-center px-6 py-12 lg:py-24">
        ...
        >
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-ink italic leading-none">Create your account</h2>
            <p className="text-sm text-ink-muted mt-2 font-sans">Start preserving memories beautifully.</p>
          </div>
          ...
          <div className="paper-sheet rounded-[28px] p-8 sm:p-10 border border-beige/45 shadow-polaroid space-y-6 relative paper-clip">
            ...
            <p className="text-center text-sm text-ink-muted font-medium pt-2 font-sans">
              ...
              <Link to="/login" className="text-pink-accent font-bold hover:underline">
                Log in
              </Link>
            </p>
          </div>
